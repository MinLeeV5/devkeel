...
describe('versions', () => {
  ...
  describe('versions', () => {
    ...
    it('should have all expected builtin versions', () => {
      ...
      expect(versions.skills['brainstorming']).toBe('9.1.0')
      expect(versions.skills['workflow-routing']).toBe('1.1.0')
      expect(versions.skills['grilling']).toBeUndefined()
      expect(versions.skills['requirement-analysis']).toBe('3.1.0')
      expect(versions.skills['technical-design']).toBe('3.1.0')
      ...
      expect(versions.skills['openspec-new-change']).toBe('2.3')
      expect(versions.skills['openspec-propose']).toBeUndefined()
      expect(versions.skills['openspec-ff-change']).toBe('2.1')
      expect(versions.skills['openspec-explore']).toBeUndefined()
      expect(versions.skills['openspec-onboard']).toBe('2.3')
      expect(versions.skills['openspec-continue-change']).toBe('2.1')
      expect(versions.skills['openspec-update-change']).toBe('2.1')
